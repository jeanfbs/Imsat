...
$(document).ready(function(){
    ...
    $("#extrair").on("click",function(){
        ...
        localStorage.setItem("tempDir",new Date().getTime());
        var par = {};
...
/*****************************************************
*   cria os links de download para as imagens e gera o Zip
******************************************************/
function download_image(linha,coluna,canvas) {
    ...
    $.ajax({
        ...
        data : {nome:fileName,image:canvas.toDataURL("image/png"),dir:localStorage.getItem("tempDir")}
    });
        ...
        case 3:
        {
            ...
            interval = setInterval(function(){
                ...
                if(i == salto_linha) // fim do loop
                {
                    ...
                    $("#pbar").width('100%');
                    $("#resultado").prepend("<div class='col-md-2'><a href='"+$("#form").attr("baseurl")+"/temp/"+localStorage.getItem("tempDir")+".zip' download>Baixar Zip</a></div>");
                    return started;
                }
